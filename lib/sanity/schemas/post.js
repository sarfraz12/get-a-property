...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      name: "gallery",
      title: "Galería (fotos o videos secundarios)",
      description:
        "Fotos o videos adicionales que se muestran como miniaturas debajo de la foto principal en la página del post. Al tocar \"+ Add item\" se puede elegir Foto o Video para cada ítem. Opcional, máximo 8 en total.",
      type: "array",
      of: [
        {
          type: "image",
        ...
        {
          // NUEVO: además de fotos, la galería ahora también acepta
          // VIDEOS -- se agregan envueltos en este objeto (en vez de
          // usar el tipo "file" suelto) para poder guardar junto al
          // archivo una portada opcional y su propio texto
          // alternativo, igual que ya se hace con los videos del
          // carrusel del Hero (landingPage.js -> hero.slides). Esto es
          // ADITIVO: los ítems de foto existentes (type "image") no se
          // tocan ni cambian de forma -- sólo se agrega esta nueva
          // opción al selector de "+ Add item".
          type: "object",
          name: "galleryVideo",
          title: "Video",
          fields: [
            {
              ...
              type: "file",
              description: "Se reproduce en loop, silenciado y automático como miniatura; con sonido y controles al ampliarlo.",
            ...
            },
            {
              ...
              description: "Miniatura que se muestra mientras el video carga. Si se deja vacía, se ve el video mismo (pausado en su primer frame).",
              type: "image",
              options: { hotspot: true },
            },
            {
          ...
          preview: {
            ...
            prepare({ media, alt }) {
              return { title: alt || "Video", subtitle: "Video", media };
            },
          },
        },
      ],
    ...
    },
    {
      ...
      description:
        'Aviso: Google confirmó que NO usa esta etiqueta para el posicionamiento -- se deja disponible solo como referencia interna / por si otros buscadores la leen. Si se deja vacío, se usan las palabras clave generales del sitio.',
      type: 'object',
      fieldset: 'seo',
      fieldsets: [{ name: 'translations', title: 'Translations', options: { collapsible: true } }],
      fields: supportedLanguages.map(lang => ({
    ...
    },
    {
      ...
      description:
        'Imagen que se muestra al compartir el link de este post en redes sociales. Tamaño recomendado: 1200x630px. Si se deja vacía, se usa la foto principal del post.',
      type: 'image',
      fieldset: 'seo',
      options: { hotspot: true },
      fields: [
