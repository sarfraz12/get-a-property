...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        'Imagen que se muestra al compartir el link de esta categoría en redes sociales. Tamaño recomendado: 1200x630px. Si se deja vacía, se usa la imagen destacada de la categoría o la imagen general del sitio.',
      type: 'image',
      fieldset: 'seo',
      options: { hotspot: true },
      fields: [
